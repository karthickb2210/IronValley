...
function HeadLine() {
  return (
    <>
      <Header />
      <div className="flex flex-wrap flex-row gap-16 justify-center py-24 mt-32 ">
        <div class="relative group cursor-pointer overflow-hidden duration-500 w-64 h-80 bg-zinc-700  text-gray-50 p-5">
          <div class=" bg-current">
            ...
            <div class="absolute w-56 left-0 p-5 -bottom-16 duration-500 group-hover:-translate-y-12">
              ...
              <p class="group-hover:opacity-80 w-54 duration-500 ">
