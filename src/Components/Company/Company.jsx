                ...
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                    <div class="max-w-xl mx-auto text-center">
                        <div class="inline-flex px-4 py-1.5 mx-auto rounded-full  ">
                            <p class="text-4xl font-semibold tracking-widest text-white text-g uppercase">Industries:</p>
                        </div>
                    ...
                    <h1 className='text-white text-center text-6xl mt-24'>Indian Companies</h1>
                    <div class="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                        ...
                        <a href="#"
                            ...
                            <div class="py-2 px-9 relative  ">
                                ...
                                <img src='/indianoil.png' alt='img' />
                                {/* <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Indian Oil
                                </h3> */}
